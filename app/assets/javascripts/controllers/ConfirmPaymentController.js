angular.module('verifier')
	.controller("ConfirmPaymentController", [ "$scope", "$http", "$location", "crudService",'$window', "$routeParams", 'ExamDietService',"ConfirmationService", "ResultService", 'ReceiptListService', 'Receipt',
		function ($scope, $http, $location, crudService,$window, $routeParams, ExamDietService, ConfirmationService, ResultService, ReceiptListService, Receipt) {
