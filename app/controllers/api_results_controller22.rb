class ApiResultsController < ApplicationController
  ...
  def index
    ...
    #binding.pry
          ##@results = ApiResult.getSearchedCandidate(params[:CandNo], params[:examYear], params[:dietId])

          @results = ApiResult.getResultStatus(params[:CandNo], params[:examYear], params[:token])
...
## For Enquiry and Confirmation Creation
...
## Injected from search helper for examination numb.length less than 10 (11032021)
 ...
 #https://ictdapps.waec.org.ng/WaecCertConfirmation/Services/GetCertificateStatusWithReason?CandidateNo=4010101003&ExamYear=2019
  ...
  if @results[0]["candNo"].length == 10
    ...
    unless @results[0]["formNo"].nil?
     ...
     #binding.pry
              ...
              resultObjects['status'] = @printedStatus == nil ? "N/A" : @printedStatus["CertificateStatus"] 
  ...
  ## For Certficate Status Enquiry

  def getCertficateEnquiryAndResultDetails
 subjectindex = {
        "101"=>"ENGLISHLANG",
        "103"=>"COMMERCE",
        "104"=>"FIN. ACCOUNTING",
