 ...
 def before_sign_in_path_for(resource)
  ...
  protected
   ...
   def configure_permitted_parameters
      added_attrs = [:office_id, :lp_no, :username, :surname, :othernames, :title, :email, :password, :password_confirmation, :is_management, :superadmin_role, :audit_role]
  ...
  #   devise_parameter_sanitizer.for(:account_update) { |u| u.permit([ :office_id, :lp_no, :username, :surname, :othernames, :title, :email, :password, :password_confirmation, :is_management]) }
