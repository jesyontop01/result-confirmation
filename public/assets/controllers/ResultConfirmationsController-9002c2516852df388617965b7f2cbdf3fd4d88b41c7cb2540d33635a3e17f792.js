									  ...
									  columns:[ 
		
											{
												...
												table: {
													...
													widths: [150, '*'],
													body: [
														['NAME OF EXAM :', {text: $scope.resultDetail[0].examType}],
														['NAME OF SCHOOL :', {text: $scope.resultDetail[0].CentreName.trim()}],
														[ 'CANDIDATE\'S NUMBER :', {text: centre+' / '+candNo }],
														[ 'CANDIDATE\'S NAME :', {text: $scope.resultDetail[0].candName}],
														[ 'ADDRESS :', {text: newValue.Cand_address}],
														[ 'SEX :', {text: $scope.resultDetail[0].sex}],
														[ 'DATE OF BIRTH :', {text: $scope.resultDetail[0].dob2}],
													]
												}
											},
...
$scope.selectConfirm = selectConfirm;  
  ...
  //         }
	...
	if (newValue.IsVeriferResult == false) {
		promisedObject = ResultDetailsFromDBForConfirmation(newValue.exam_no, newValue.examYear, newValue.DietName, newValue.id, newValue.isPrinted);
